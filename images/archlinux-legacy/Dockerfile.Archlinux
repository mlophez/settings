...
#RUN pacman -Sy sudo git $(cat /archlinux.packages | grep -v "^ *#" | tr '\n' ' ') --noconfirm && pacman -Scc --noconfirm
RUN pacman -Syu --noconfirm && pacman -Sy sudo git --noconfirm && pacman -Scc --noconfirm
