...
NORD_TMUX_COLOR_THEME_FILE=nord.conf
NORD_TMUX_VERSION=0.3.0
NORD_TMUX_STATUS_CONTENT_FILE="nord-status-content.conf"
NORD_TMUX_STATUS_CONTENT_NO_PATCHED_FONT_FILE="nord-status-content-no-patched-font.conf"
